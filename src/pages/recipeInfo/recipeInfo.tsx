        ...
        <div className={styles.rContainer}>
          <div className={styles.rContent}>
            <div className={styles.rPost}>
              ...
              <p className={styles.rDescription}>
                {fetchedRecipeInfo && fetchedRecipeInfo.summary !== null
                  ? parse(fetchedRecipeInfo.summary)
                  : ''}
              </p>
            </div>
            <img
              src={
                fetchedRecipeInfo && fetchedRecipeInfo.imageType !== null
                  ? fetchedRecipeInfo.image
                  : ''
              }
              alt={
                fetchedRecipeInfo && fetchedRecipeInfo.title !== null ? fetchedRecipeInfo.title : ''
              }
          ...
          <div className={styles.sContainer}>
            {fetchedSimilarRecipes.length > 0 &&
              fetchedSimilarRecipes.map(
                (recipe) => recipe && <SimilarRecipe key={recipe.id} recipe={recipe} />,
              )}
          </div>
        </div>
      )}
